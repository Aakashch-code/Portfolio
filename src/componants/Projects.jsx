...
const projects = [
    {
        ...
        description: [
            "Built a personal finance backend system using Java 21 and Spring Boot to explore backend engineering concepts.",
            "Designed the system as a modular monolith with feature-based modules (Treasury, Wealth, Protection) and layered architecture (API, Application, Domain, Persistence).",
            "Implemented 45+ RESTful APIs for transactions, budgeting, financial goals, assets, liabilities, insurance, net worth tracking, and contingency planning.",
            ...
            "Secured APIs using Spring Security with JWT-based authentication and built a lightweight React interface for end-to-end workflows.",
            "Integrated the Google Gemini API to generate AI-powered financial insights and summaries."
        ],
